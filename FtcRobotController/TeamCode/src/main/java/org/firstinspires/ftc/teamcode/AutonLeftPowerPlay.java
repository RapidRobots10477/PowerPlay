...
@Autonomous(name="Auton LEFT PowerPlay Medium Pole", group="Medium")

public class AutonLeftPowerPlay extends LinearOpMode {
    ...
    **/
    ...
    public void runOpMode() {
        ...
        holdHeading(TURN_SPEED,  40.0, 0.6);
        ...
        turnToHeading(TURN_SPEED, 95.0);
        holdHeading(TURN_SPEED,  135.0, 0.5);
        driveStraight(DRIVE_SPEED, 13.0, 135);
        moveArmDown(-845);
        openClaw();
        holdHeading(TURN_SPEED,  135.0, 0.5);
        driveStraight(DRIVE_SPEED, -13.0, 135);
    ...
    /*driveStraight(DRIVE_SPEED, -70, 0.5);
    moveArmUp(HIGH_POLE);
    turnToHeading(TURN_SPEED,135.0, 0.6);*/
