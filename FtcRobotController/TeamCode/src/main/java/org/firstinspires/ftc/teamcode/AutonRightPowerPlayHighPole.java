...
@Autonomous(name="Auton Right PowerPlay High Pole", group="High")

public class AutonRightPowerPlayHighPole extends LinearOpMode {
    ...
    **/
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive()) {
            ...
            moveArmUp(HIGH_POLE);
            driveStraight(DRIVE_SPEED, 10.5, 45.0);
            ...
            turnToHeading(TURN_SPEED, 45.0);
            holdHeading(TURN_SPEED,  45.0, 0.5);
            driveStraight(DRIVE_SPEED, -9.5, 45);
            moveArmDown(-1100);
            openClaw();
