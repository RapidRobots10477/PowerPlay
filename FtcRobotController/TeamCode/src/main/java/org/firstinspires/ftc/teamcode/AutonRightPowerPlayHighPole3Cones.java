...
@Autonomous(name="Auton Right PowerPlay HighPole 3 Cones", group="High")

public class AutonRightPowerPlayHighPole3Cones extends LinearOpMode {
    ...
    **/
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive()) {
            ...
            moveArmUp(HIGH_POLE);
            driveStraight(DRIVE_SPEED, 11, 45.0);
