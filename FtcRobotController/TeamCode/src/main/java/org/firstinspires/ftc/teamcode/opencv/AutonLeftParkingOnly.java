...
@Autonomous(name="Auton LEFT Parking Only", group="AprilTags")

public class AutonLeftParkingOnly extends LinearOpMode {
    ...
    static final int RELEASE_LOW_POLE    = -900;
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive()) {
            ...
            moveArmUp(HIGH_POLE);
            driveStraight(DRIVE_SPEED, 9.0, -45.0);
            holdHeading(TURN_SPEED,  -45.0, 0.50);
            ...
            */
            ...
            holdHeading(TURN_SPEED,  -90.0, 1.00);
            //moveArmUp(HIGH_POLE);
            //driveStraight(DRIVE_SPEED, 9.0, -45.0);
            //holdHeading(TURN_SPEED,  -45.0, 0.50);
            //moveArmDown(RELEASE_HIGH_POLE);
...
/*
            ...
            if (startTimer.time() >= 11.0) {
                ...
                driveStraight(DRIVE_SPEED, -10.0, -90);
                closeClaw();
                holdHeading(TURN_SPEED,  -90.0, 0.25);
                moveArmUp(LOW_POLE);
                holdHeading(TURN_SPEED,  -90.0, 0.25);
                ...
                driveStraight(DRIVE_SPEED, 8.0, -45);
                turnToHeading(TURN_SPEED, -90);
            }
...
*/
            ...
            switch (detectedSignal) {
                ...
                case RIGHT:
                    //turnToHeading(TURN_SPEED, 90);
                    driveStraight(DRIVE_SPEED, 22.0, -90);
                    break;
            }
            moveArmDown(0);
            closeClaw();
