...
@Autonomous(name="Auton Right ATags HighPole 3 Cones Backup", group="AprilTags")
@Disabled
public class AutonRightPowerPlayHighPole3ConesTags_Copy extends LinearOpMode {
...
*/
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive()) {
            ...
            holdHeading(TURN_SPEED,  45.0, 1.0);
            moveArmUp(HIGH_POLE);
            driveStraight(DRIVE_SPEED, 9.5, 45.0);
